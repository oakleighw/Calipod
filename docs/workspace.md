...
As input video files are added and cameras are calibrated, you may need to click `Reload Workspace` for them to be recognized, or for other tabs (i.e. `Calibration`, `Capture Volume` and `Post Processing`) to become available.
